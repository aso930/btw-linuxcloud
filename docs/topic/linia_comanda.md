...
- ~/ sau ~ va fi substituit cu $HOME/director $ echo ~ /Users/user1
- ~+/ sau ~+ va fi substituit de $PWD $ echo ~+ /Users/user1/Music
...
6. Substituirea proceselor (redirecționarea canalelor) -- exemplu  1>/dev/null 2>&1
